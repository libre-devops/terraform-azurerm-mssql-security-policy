...
module "mssql_security_policy" {
  source = "../../"

  security_policies = [
    {
      rg_name     = module.rg.rg_name
      server_name = module.mssql_servers.mssql_server_name["mssql-server-${var.short}-${var.loc}-${var.env}-01"]

      vulnerability_assessment = {
        enabled                    = true
        storage_container_path     = "${module.sa.primary_blob_endpoints["sa${var.short}${var.loc}${var.env}01"]}${azurerm_storage_container.security_alerts.name}/"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_mssql_security_policy"></a> [mssql\_security\_policy](#module\_mssql\_security\_policy) | ../../ | n/a |
